...
def setup_js():
    try:
        ...
        js_src_path = os.path.join(gemini_path, "extensions2")
        js_srcCss_file = os.path.join(gemini_path, "CSS", "user.css")  # Đường dẫn nguồn file use.css
...
WEB_DIRECTORY = "./extensions"  # so ComfyUI can use custom CSS/JS
